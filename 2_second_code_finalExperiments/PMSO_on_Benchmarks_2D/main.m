...
global Number_of_dimensions_of_landscape; Number_of_dimensions_of_landscape = 2;   % should be <= 100 (according to data in benchmark dataset)
...
for function_landscape = 1:Number_of_landscape_functions  % should be an integer in limit [1, Number_of_landscape_functions]
