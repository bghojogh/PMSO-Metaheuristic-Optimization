...
function [time_betterSolutionFound, bestFitnessArray] = PMSO(x,y,z, GammarusNum, step, initial_Location, GlobalIterationNum, disp_figures_and_results)
...
GammarusLoc(1,:) = initial_Location(1,:);
GammarusLoc(2,:) = initial_Location(2,:);
